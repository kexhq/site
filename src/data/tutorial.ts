...
export const TUTORIAL_NAV: TutorialSection[] = [
  {
    ...
    entries: [
      ...
      { title: "Functions", slug: "functions", blurb: "Defining functions, multi-clause, UFCS.", status: "ready" },
    ],
  },
  {
    ...
    entries: [
      ...
      { title: "Pipelines & UFCS", slug: "pipelines", blurb: "Chaining functions like methods.", status: "ready" },
